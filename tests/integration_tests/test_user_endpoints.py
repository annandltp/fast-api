...
#
# def test_delete_user_fails(testing_app, valid_user_delete_id):
#     response = testing_app.delete(f"/user/{valid_user_delete_id}")
#     print(response.status_code)
#     assert response.status_code == 200
#
...
#     # assert second_response.json() == "User doesn't exist"
#
# def test_put_returns_correct_results(testing_app, sample_full_user_profile):
#     user_id = 21
#     response = testing_app.put(f"/user/{user_id}", json=sample_full_user_profile.dict())
#
#     assert response.status_code == 200
#
# def test_put_twice_returns_correct_results(testing_app, sample_full_user_profile):
#     user_id = 21
#     response = testing_app.put(f"/user/{user_id}", json=sample_full_user_profile.dict())
#
#     assert response.status_code == 200
...
def test_get_valid_user_returns_correct_results(testing_app, valid_user_id):
